...
alter table colocados add constraint un_col unique(idCandidato,curso); -- Trabalho feito
...
insert into matriculas values (seq_num_aluno.nextval, 143146, '9209', to_date('2021.09.11', 'YYYY.MM.DD'));
...
-- 2.2
-- ***** Trabalho *****
-- Vamos testar matriculando o aluno 72111 (ou outro/a à sua escolha) em Informática 
insert into matriculas values(seq_num_aluno.nextval,72111 ,'9119',to_date('2021.09.11', 'YYYY.MM.DD'));
